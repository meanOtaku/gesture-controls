# Graph Report - gesture-controls  (2026-08-23)

## Corpus Check
- 88 files · ~66,143 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1254 nodes · 2062 edges · 94 communities (90 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2b035f1`
...
1. `WatchLinkManager` - 37 edges
2. `MainActivity` - 28 edges
3. `WatchBridgeServer` - 20 edges
4. `Sony Head Tracker` - 20 edges
5. `Sony Head Tracker` - 20 edges
6. `WatchProtocol` - 19 edges
7. `VolumeError` - 19 edges
8. `WatchEvent` - 19 edges
9. `OverlayRuntime` - 18 edges
10. `WatchStatus` - 18 edges
...
Cohesion: 0.06
Nodes (51): App(), emptyOverlay, emptyStatus, emptyWatchStatus, { invoke, listeners, listen }, Dashboard(), DashboardProps, number() (+43 more)
...
Cohesion: 0.10
Nodes (37): ClockOffsetEstimate, estimate_clock_offset(), handle_inbound(), handle_socket(), MdnsAdvertisement, MeasurementCommand, median_clock_offset(), now_ns() (+29 more)
...
Cohesion: 0.09
Nodes (52): DesktopConnectedPayload, DesktopMeasurementCommandPayload, DesktopOutboundEnvelope, DesktopOutboundEnvelope<T>, DesktopTimeSyncPayload, HeadPose, Error, Option (+44 more)
...
Cohesion: 0.15
Nodes (25): batch_rate_hz(), EcgSampleSnapshot, EdaSampleSnapshot, get_medical_tracker_ids(), get_watch_status(), HeartRateSampleSnapshot, PpgSampleSnapshot, AppHandle (+17 more)
...
### Community 52 - "WatchPairingServer"
Cohesion: 0.24
...
Cohesion: 0.10
Nodes (7): FloatArray, JSONObject, StateFlow, WebSocket, WatchLinkManager, Job, tracker

### Community 59 - "PpgCollector"
Cohesion: 0.13
...
### Community 66 - "MedicalTrackerState"
Cohesion: 0.14
Nodes (11): HealthTrackingService, StateFlow, MedicalContinuousCollector, MedicalTrackerState, CONNECTING, ERROR, IDLE, MEASURING (+3 more)
...
### Community 71 - "SensorCollector"
Cohesion: 0.23
Nodes (5): FloatArray, SensorCollector, Sensor, SensorEvent, SensorEventListener

### Community 72 - "ConnectionState"
Cohesion: 0.25
...
### Community 78 - "Galaxy Watch WebSocket protocol"
Cohesion: 0.18
Nodes (8): Galaxy Watch WebSocket protocol, Local discovery, Raw PPG (Galaxy Watch 4+ Samsung Wear OS only), Time synchronization, Volume overlay grab (STEM button), Watch messages, Sony Head Tracker, Third-party notices
...
### Community 84 - "[2.0.0] - 2026-07-04"
Cohesion: 0.40
Nodes (5): [2.0.0] - 2026-07-04, Added, Changed, Compatibility, Fixed

### Community 85 - "Compatibility"
Cohesion: 0.40
Nodes (5): Candidate, Compatibility, Confirmed, Not compatible, Why AirPods can't work (yet)

### Community 86 - "[1.4.0] - 2026-07-03"
Cohesion: 0.50
Nodes (4): [1.4.0] - 2026-07-03, Added, Changed, Fixed

### Community 87 - "[2.1.0] - 2026-07-09"
Cohesion: 0.50
Nodes (4): [2.1.0] - 2026-07-09, Added, Changed, Compatibility

### Community 88 - "[2.2.0] - 2026-07-11"
Cohesion: 0.50
...
### Community 92 - "[2.1.0] - 2026-07-09"
Cohesion: 0.50
Nodes (4): [2.1.0] - 2026-07-09, Added, Changed, Compatibility

### Community 93 - "[1.1.0] - 2026-07-02"
Cohesion: 0.67
Nodes (3): [1.1.0] - 2026-07-02, Added, Changed

## Knowledge Gaps
- **380 isolated node(s):** `DISCOVERED`, `PERSISTED_FALLBACK`, `DESKTOP_INITIATED`, `IDLE`, `PERMISSION_REQUIRED` (+375 more)
...
- **Why does `MainActivity` connect `MainActivity` to `MedicalTrackerState`, `SensorCollector`, `ConnectionState`, `EndpointSource`, `OnDemandMedicalSampler`, `ContentView`, `WatchPairingServer`, `DesktopDiscovery`, `PpgCollector`?**
