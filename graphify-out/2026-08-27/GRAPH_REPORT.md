# Graph Report - gesture-controls  (2026-08-27)

## Corpus Check
- 97 files · ~73,923 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1395 nodes · 2408 edges · 106 communities (98 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74972274`
...
Cohesion: 0.08
Nodes (31): App(), emptyOverlay, { invoke, listeners, listen }, BiaResultSnapshot, CALIBRATION_STATE_EVENT, EcgSampleSnapshot, EdaSampleSnapshot, HEAD_POSE_EVENT (+23 more)
...
Cohesion: 0.10
Nodes (39): ClockOffsetEstimate, estimate_clock_offset(), handle_inbound(), handle_socket(), MdnsAdvertisement, MeasurementCommand, median_clock_offset(), now_ns() (+31 more)
...
Cohesion: 0.17
Nodes (16): chartPath(), csvEscape(), formatBytes(), LiveTelemetry(), number(), TimeChart(), CsvRow, EMPTY_HEAD_STATUS (+8 more)
...
Cohesion: 0.16
Nodes (25): apply_watch_settings(), AppSettings, defaults_pass_validation(), get_settings(), in_range(), load_or_default(), rejects_out_of_range_rate(), rejects_unknown_sensor_key() (+17 more)
...
### Community 99 - "Spatial Gesture Control"
Cohesion: 0.18
...
### Community 103 - "Galaxy Watch WebSocket protocol"
Cohesion: 0.29
...
### Community 105 - "[1.2.0] - 2026-07-02"
Cohesion: 0.67
Nodes (3): [1.2.0] - 2026-07-02, Added, Fixed
...
- **Why does `MainActivity` connect `MainActivity` to `EndpointSource`, `SensorCollector`, `OnDemandMedicalSampler`, `PpgCollector`, `ContentView`, `MedicalContinuousCollector`, `WatchPairingServer`, `DesktopDiscovery`?**
...
- **Should `WatchBridgeServer` be split into smaller, more focused modules?**
