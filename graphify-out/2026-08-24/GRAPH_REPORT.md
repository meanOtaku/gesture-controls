# Graph Report - gesture-controls  (2026-08-24)

## Corpus Check
- 88 files · ~66,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1258 nodes · 2075 edges · 86 communities (80 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0daaf68`
...
- [2.1.0] - 2026-07-09
- .dispatchMeasurementCommand

## God Nodes (most connected - your core abstractions)
1. `WatchLinkManager` - 38 edges
...
Cohesion: 0.06
Nodes (54): App(), emptyOverlay, emptyStatus, emptyWatchStatus, { invoke, listeners, listen }, Dashboard(), DashboardProps, number() (+46 more)
...
Cohesion: 0.11
Nodes (6): FloatArray, StateFlow, WebSocket, WatchLinkManager, Job, tracker
...
Cohesion: 0.10
Nodes (16): HealthTrackingService, StateFlow, MedicalContinuousCollector, MedicalTrackerState, CONNECTING, ERROR, IDLE, MEASURING (+8 more)
...
Cohesion: 0.20
Nodes (6): ConnectionPrefs, MainActivity, AppCompatActivity, Bundle, PpgState, TextView
...
### Community 83 - "Spatial Gesture Control"
Cohesion: 0.18
...
- **Why does `MainActivity` connect `MainActivity` to `MedicalTrackerState`, `SensorCollector`, `ConnectionState`, `EndpointSource`, `.releaseStemButtonIfPressed`, `ContentView`, `WatchPairingServer`, `DesktopDiscovery`, `PpgCollector`?**
