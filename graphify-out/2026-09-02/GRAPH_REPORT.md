# Graph Report - gesture-controls  (2026-09-01)

## Corpus Check
- 117 files · ~88,059 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1651 nodes · 3027 edges · 112 communities (103 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5aa0d66b`
...
Cohesion: 0.05
Nodes (40): 1. Put the watch and your desktop on the same Wi-Fi network, 2. Enable Developer Options and Wi-Fi debugging on the watch, 3. Connect adb to the watch, 4. Install and run from Android Studio, 5. Start the desktop app, 6. Confirm automatic pairing, 7. Firewall, Deploying to a Galaxy Watch 4 (+32 more)
...
## Knowledge Gaps
- **413 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+408 more)
