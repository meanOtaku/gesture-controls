# Graph Report - gesture-controls  (2026-08-30)

## Corpus Check
- 97 files · ~75,961 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1431 nodes · 2515 edges · 107 communities (100 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d0760bd`
...
### Community 103 - "WatchPairingServer"
Cohesion: 0.24
...
- **Why does `MainActivity` connect `MainActivity` to `EndpointSource`, `WatchPairingServer`, `SensorCollector`, `OnDemandMedicalSampler`, `ContentView`, `MedicalTrackerState`, `MedicalContinuousCollector`, `PpgCollector`, `DesktopDiscovery`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `WatchLinkManager` connect `WatchLinkManager` to `.dispatchSamples`, `ConnectionState`, `.handleInbound`, `MedicalContinuousCollector.kt`, `PpgState`, `scripts`?**
