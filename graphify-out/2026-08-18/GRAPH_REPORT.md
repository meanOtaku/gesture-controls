...
## Corpus Check
- 80 files · ~51,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 996 nodes · 1519 edges · 64 communities (59 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `04e3bdae`
...
4. `WatchLinkManager` - 17 edges
5. `compilerOptions` - 17 edges
6. `CalibrationRuntime` - 16 edges
7. `OverlayRuntime` - 16 edges
8. `SonyUdpHeadPoseProvider` - 16 edges
9. `HeadCalibration` - 16 edges
10. `run_command_with_timeout()` - 16 edges
...
Cohesion: 0.06
Nodes (31): 1. Put the watch and your desktop on the same Wi-Fi network, 2. Enable Developer Options and Wi-Fi debugging on the watch, 3. Connect adb to the watch, 4. Install and run from Android Studio, 5. Find your desktop's LAN IP and start the desktop app, 6. Enter the endpoint on the watch and connect, 7. Firewall, Deploying to a Galaxy Watch 4 (+23 more)
...
Cohesion: 0.09
Nodes (12): ConnectionPrefs, MainActivity, FloatArray, SensorCollector, AppCompatActivity, Bundle, Button, EditText (+4 more)

### Community 58 - "WatchLinkManager"
Cohesion: 0.12
Nodes (11): ConnectionState, CONNECTED, CONNECTING, DISCONNECTED, FAILED, RECONNECTING, FloatArray, WebSocket (+3 more)

### Community 59 - "WatchProtocol"
Cohesion: 0.32
Nodes (5): InboundMessage, FloatArray, WatchProtocol, JSONArray, JSONObject

## Knowledge Gaps
- **348 isolated node(s):** `DISCONNECTED`, `CONNECTING`, `CONNECTED`, `RECONNECTING`, `FAILED` (+343 more)
