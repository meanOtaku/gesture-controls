# Graph Report - gesture-controls  (2026-08-29)

## Corpus Check
- 97 files · ~75,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1419 nodes · 2487 edges · 102 communities (96 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46a1504a`
...
1. `WatchLinkManager` - 44 edges
2. `TelemetryStore` - 36 edges
3. `MainActivity` - 31 edges
4. `WatchBridgeServer` - 25 edges
5. `OverlayRuntime` - 22 edges
6. `WatchProtocol` - 20 edges
7. `WatchEvent` - 20 edges
8. `Sony Head Tracker` - 20 edges
9. `Sony Head Tracker` - 20 edges
10. `VolumeError` - 19 edges
...
Cohesion: 0.09
Nodes (29): App(), emptyOverlay, { invoke, listeners, listen }, BiaResultSnapshot, CALIBRATION_STATE_EVENT, EcgSampleSnapshot, EdaSampleSnapshot, HEAD_POSE_EVENT (+21 more)
...
Cohesion: 0.06
Nodes (67): batch_rate_hz(), EcgSampleSnapshot, EdaSampleSnapshot, get_controllable_sensor_ids(), get_medical_tracker_ids(), get_watch_status(), HeartRateSampleSnapshot, PpgSampleSnapshot (+59 more)
...
Cohesion: 0.14
Nodes (29): adjust_system_volume(), get_overlay_state(), hide_overlay(), OverlayRuntime, OverlayState, position_window_at_top_right(), prepare_window(), refresh_system_volume() (+21 more)
...
Cohesion: 0.20
Nodes (14): chartPath(), csvEscape(), formatBytes(), LiveTelemetry(), number(), TimeChart(), CsvRow, EMPTY_HEAD_STATUS (+6 more)
...
Cohesion: 0.10
Nodes (18): Any, Namespace, Socket, Send a single simulated Sony Head Tracker version-2 sample., _arguments(), main(), Command-line monitor for Sony head-pose samples., Sony headphone head-tracking receiver. (+10 more)
...
Cohesion: 0.08
Nodes (56): DesktopConnectedPayload, DesktopMeasurementCommandPayload, DesktopOutboundEnvelope, DesktopOutboundEnvelope<T>, DesktopSensorControlPayload, DesktopSensorRateCommandPayload, DesktopTimeSyncPayload, HeadPose (+48 more)
...
Cohesion: 0.05
Nodes (39): 1. Put the watch and your desktop on the same Wi-Fi network, 2. Enable Developer Options and Wi-Fi debugging on the watch, 3. Connect adb to the watch, 4. Install and run from Android Studio, 5. Start the desktop app, 6. Confirm automatic pairing, 7. Firewall, Deploying to a Galaxy Watch 4 (+31 more)
...
### Community 39 - "TelemetryStore"
Cohesion: 0.09
Nodes (8): RingBuffer, TelemetryStore, HeadPosePayload, WatchEdaBatch, WatchHeartRateBatch, WatchPpgBatch, WatchSkinTemperatureBatch, WatchStatus
...
Cohesion: 0.08
Nodes (10): FloatArray, JSONObject, sensor, StateFlow, WebSocket, WatchLinkManager, enabled, Job (+2 more)
...
Cohesion: 0.13
Nodes (7): AppCompatActivity, MainActivity, ConnectionPrefs, Bundle, KeyEvent, PpgState, TextView
...
### Community 89 - "WatchPairingServer"
Cohesion: 0.24
...
### Community 104 - "[2.1.0] - 2026-07-09"
Cohesion: 0.50
Nodes (4): [2.1.0] - 2026-07-09, Added, Changed, Compatibility

### Community 105 - "[1.1.0] - 2026-07-02"
Cohesion: 0.67
Nodes (3): [1.1.0] - 2026-07-02, Added, Changed
...
- **Why does `MainActivity` connect `MainActivity` to `EndpointSource`, `SensorCollector`, `OnDemandMedicalSampler`, `ContentView`, `MedicalContinuousCollector`, `PpgCollector`, `WatchPairingServer`, `DesktopDiscovery`?**
