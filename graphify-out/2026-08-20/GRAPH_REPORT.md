...
## Corpus Check
- 83 files · ~55,500 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1067 nodes · 1645 edges · 70 communities (65 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.74)
...
1. `WatchLinkManager` - 21 edges
2. `MainActivity` - 20 edges
3. `Sony Head Tracker` - 20 edges
4. `Sony Head Tracker` - 20 edges
5. `VolumeError` - 19 edges
6. `compilerOptions` - 17 edges
7. `CalibrationRuntime` - 16 edges
8. `OverlayRuntime` - 16 edges
9. `SonyUdpHeadPoseProvider` - 16 edges
10. `HeadCalibration` - 16 edges
...
Cohesion: 0.10
Nodes (37): ClockOffsetEstimate, estimate_clock_offset(), handle_inbound(), handle_socket(), MdnsAdvertisement, median_clock_offset(), now_ns(), Arc (+29 more)
...
Cohesion: 0.12
Nodes (29): DesktopConnectedPayload, DesktopOutboundEnvelope, DesktopOutboundEnvelope<T>, DesktopTimeSyncPayload, HeadPose, Error, Option, Result (+21 more)
...
Cohesion: 0.05
Nodes (34): 1. Put the watch and your desktop on the same Wi-Fi network, 2. Enable Developer Options and Wi-Fi debugging on the watch, 3. Connect adb to the watch, 4. Install and run from Android Studio, 5. Start the desktop app, 6. Confirm automatic discovery or enter a manual fallback endpoint, 7. Firewall, Deploying to a Galaxy Watch 4 (+26 more)
...
Cohesion: 0.05
Nodes (21): ConnectionPrefs, DesktopDiscovery, NsdManager, NsdManager, MainActivity, StateFlow, PpgCollector, FloatArray (+13 more)
...
Cohesion: 0.13
Nodes (13): PpgSample, PpgState, CONNECTING, ERROR, IDLE, PERMISSION_REQUIRED, STREAMING, UNAVAILABLE (+5 more)
...
## Knowledge Gaps
- **361 isolated node(s):** `IDLE`, `PERMISSION_REQUIRED`, `CONNECTING`, `STREAMING`, `UNAVAILABLE` (+356 more)
