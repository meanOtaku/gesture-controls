...
## Corpus Check
- 116 files · ~87,567 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1637 nodes · 3004 edges · 114 communities (105 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e9ae570`
...
- **Why does `WatchLinkManager` connect `WatchLinkManager` to `.dispatchSamples`, `ConnectionState`, `MedicalContinuousCollector.kt`, `PpgState`, `.handleInbound`, `scripts`?**
